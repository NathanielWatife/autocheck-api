...
class UserProfile(models.Model):
    ...
    savefd_vehicles = models.ManyToManyField('vehicles.Vehicle', related_name='saved_by_users', blank=True)
    bio = models.TextField(max_length=200, null=True, blank=True)
    avatar = models.ImageField(upload_to='avatars/', null=True, blank=True)
    watchlist = models.ManyToManyField('self', symmetrical=False, related_name='watchlisted_by', blank=True)
